...
dest_folder = dataiku.Folder(get_output_names_for_role('sftp_folder')[0])

if dest_folder.get_info().get("type") != "fsprovider_sftp-python_sftp-python_sftp-fs-provider":
    raise TypeError(" This recipe expects a sftp-python folder as an output")
